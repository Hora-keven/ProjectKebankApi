# Generated by Django 4.2.6 on 2023-12-07 00:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(decimal_places=2, max_digits=10)),
                ('type_movimentation', models.CharField(choices=[('P', 'Pix'), ('Pix cartão de crédito', 'Pix cartão crédito'), ('Empréstimo', 'Empréstimo')], default='Pix', max_length=100, null=True)),
